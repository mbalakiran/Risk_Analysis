...
getSymbols("MSFT",from="2009-10-01",to="2019-10-18") # Microsoft 
getSymbols("INTC",from="2009-10-01",to="2019-10-18") #Intel
getSymbols("T",from="2009-10-01",to="2019-10-18")   # AT&T
getSymbols("KO",from="2009-10-01",to="2019-10-18")  # Coca Cola
getSymbols("WMT",from="2009-10-01",to="2019-10-18") #Walmart
...
MSFT_log_returns
#Intel log returns from 2009 oct 1 to 2019 oct 18
INTC_log_returns
#
T_log_returns
KO_log_returns
...
final_mat[300,-1]%>%as.numeric()%>%quantile
